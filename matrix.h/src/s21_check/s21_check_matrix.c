...
Suite *s21_matrix_suite(void) {
  ...
  tcase_add_test(tcase_core, compliment_test_1);  // compliments
  tcase_add_test(tcase_core, compliment_test_2);
  tcase_add_test(tcase_core, compliment_test_not_square);
  tcase_add_test(tcase_core, compliment_test_1x1);
  tcase_add_test(tcase_core, null_compliments);
  tcase_add_test(tcase_core, create_test);  // create
  tcase_add_test(tcase_core, create_test_incorrect);
  tcase_add_test(tcase_core, determinant_test_1);  // determinant
  tcase_add_test(tcase_core, determinant_test_2);
  tcase_add_test(tcase_core, determinant_test_3x3_1);
  tcase_add_test(tcase_core, determinant_test_3x3_2);
  tcase_add_test(tcase_core, determinant_test_3x3_3);
  tcase_add_test(tcase_core, determinant_test_3x3_4);
  tcase_add_test(tcase_core, determinant_test_4x4);
  tcase_add_test(tcase_core, determinant_test_4x4_2);
  tcase_add_test(tcase_core, determinant_test_5x5);
  tcase_add_test(tcase_core, determinant_not_square);
  tcase_add_test(tcase_core, null_determinate);
  tcase_add_test(tcase_core, eq_test_1);  // eq
  tcase_add_test(tcase_core, eq_test_2);
  tcase_add_test(tcase_core, eq_test_3);
  tcase_add_test(tcase_core, eq_test_diff_size);
  tcase_add_test(tcase_core, test_normal);  // inverse
  tcase_add_test(tcase_core, test_not_sqare);
  tcase_add_test(tcase_core, null_inverse);
  tcase_add_test(tcase_core, zero_det);
  tcase_add_test(tcase_core, incorrect_matrix_1);  // mult_matrix
  tcase_add_test(tcase_core, incorrect_matrix_2);
  ...
  tcase_add_test(tcase_core, null_mult_mat);
  tcase_add_test(tcase_core, mult_number_test_1);  // mult_number
  tcase_add_test(tcase_core, mult_number_test_2);
  tcase_add_test(tcase_core, mult_number_test_3);
  tcase_add_test(tcase_core, null_mult_num);
  tcase_add_test(tcase_core, remove_test);  // remove
  tcase_add_test(tcase_core, sub_test_1);   // sub
  tcase_add_test(tcase_core, sub_test_2);
  tcase_add_test(tcase_core, sub_test_incorrect_matrix);
  tcase_add_test(tcase_core, null_sub);
  tcase_add_test(tcase_core, sum_test_1);  // sum
  tcase_add_test(tcase_core, sum_test_2);
  tcase_add_test(tcase_core, sum_test_incorrect_matrix);
  tcase_add_test(tcase_core, null_sum);
  tcase_add_test(tcase_core, transpose_test_1);  // transpose
  tcase_add_test(tcase_core, transpose_test_2);
  tcase_add_test(tcase_core, transpose_incorrect);
  tcase_add_test(tcase_core, null_transpose);
